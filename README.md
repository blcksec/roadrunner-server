...
<p align="center">
 <a href="https://packagist.org/packages/spiral/roadrunner"><img src="https://poser.pugx.org/spiral/roadrunner/version"></a>
	<a href="https://pkg.go.dev/github.com/blcksec/roadrunner/v2?tab=doc"><img src="https://godoc.org/github.com/blcksec/roadrunner/v2?status.svg"></a>
    <a href="https://twitter.com/spiralphp"><img src="https://img.shields.io/twitter/follow/spiralphp?style=social"></a>
    <a href="https://codecov.io/gh/blcksec/roadrunner/"><img src="https://codecov.io/gh/blcksec/roadrunner/branch/master/graph/badge.svg"></a>
	<a href="https://github.com/blcksec/roadrunner/actions"><img src="https://github.com/blcksec/roadrunner/workflows/rr_cli_tests/badge.svg" alt=""></a>
	...
	<a href="https://goreportcard.com/report/github.com/blcksec/roadrunner"><img src="https://goreportcard.com/badge/github.com/blcksec/roadrunner"></a>
	<a href="https://lgtm.com/projects/g/blcksec/roadrunner/alerts/"><img alt="Total alerts" src="https://img.shields.io/lgtm/alerts/g/blcksec/roadrunner.svg?logo=lgtm&logoWidth=18"/></a>
	<a href="https://discord.gg/TFeEmCs"><img src="https://img.shields.io/badge/discord-chat-magenta.svg"></a>
	<a href="https://packagist.org/packages/spiral/roadrunner"><img src="https://img.shields.io/packagist/dd/spiral/roadrunner?style=flat-square"></a>
    <img alt="All releases" src="https://img.shields.io/github/downloads/blcksec/roadrunner/total">
</p>
...
image and tags can be found [here](https://hub.docker.com/r/spiralscout/roadrunner/)) or use the GitHub package: `ghcr.io/blcksec/roadrunner:2.X.X`


- Docker:

```dockerfile
FROM ghcr.io/blcksec/roadrunner:2.X.X AS roadrunner
FROM php:8.1-cli
...
```bash
$ wget https://github.com/blcksec/roadrunner/releases/download/v2.X.X/roadrunner-2.X.X-linux-amd64.deb
$ sudo dpkg -i roadrunner-2.X.X-linux-amd64.deb
```


Configuration can be located in `.rr.yaml`
file ([full sample](https://github.com/blcksec/roadrunner/blob/master/.rr.yaml)):
...
<a href="https://github.com/blcksec/roadrunner/graphs/contributors">
  <img src="https://contributors-img.web.app/image?repo=blcksec/roadrunner" />
</a>
